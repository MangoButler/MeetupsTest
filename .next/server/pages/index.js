...
async function getStaticProps(context) {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://christianhegi:nY0GE1QqBGx35ETk@reactcluster.d7gxulp.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
